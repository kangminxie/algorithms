...
/**
 * Driver test for ProcessHeap
 * Directly copied from instructor's web page
 * Step-1, initialize the heap, test the printHeap;
 * Step-2, add several new process, test remove, peek isEmpty at the big loop
 */
